...
public class EnemySpawner : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        enemiesPerWave = runData.GetEnemiesPerWave(baseEnemiesPerWave);
    ...
    /*private IEnumerator WaveLoop()
    {
        ...
        while (currentWave < maxWaves)
        {
            ...
            runData.OnWaveCleared(enemyIncreasePerWave);
        }
    ...
    {
        int markersToSpawn = enemiesPerWave;
        List<Vector2> usedPositions = new List<Vector2>();

        for (int i = 0; i < markersToSpawn; i++)
        {
            Vector3 spawnPos;
            ...
            else
            {
                ...
                Instantiate(spawnPointPrefab, spawnPos, Quaternion.identity);
            }
    ...
    private IEnumerator SpawnWave()
    {
        ...
        for (int i = 0; i < enemiesToSpawn; i++)
        {
            ...
            if (spawnObject != null)
            {
                spawnObject.Init(difficultyLevel, this);
            }
